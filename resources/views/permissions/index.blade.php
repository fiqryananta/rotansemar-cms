                ...
                <div class="border-b border-gray-200 p-6">
                    <form id="filter-form" method="GET" action="{{ route('permissions.index') }}" class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button type="submit" class="inline-flex h-10 items-center rounded-md bg-rose-600 px-4 text-sm font-medium text-white transition hover:bg-rose-700">Cari</button>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 text-right">
                                            <div class="flex justify-end gap-2">
                                                ...
                                                <form method="POST" action="{{ route('permissions.destroy', $permission->id) }}" data-confirm="Yakin ingin menghapus permission {{ addslashes($permission->name) }}?">
                                                    @csrf
                                                    @method('DELETE')
