...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={`border-t border-gray-200 bg-gray-50 font-medium [&>tr]:last:border-b-0 ${className}`}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={`h-10 px-2 text-left align-middle font-semibold text-gray-900 [&:has([role=checkbox])]:pr-0 ${className}`}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={`px-2 py-3 align-middle text-gray-700 [&:has([role=checkbox])]:pr-0 ${className}`}
    {...props}
  />
))
