...
export default function KegiatanPenyuluhanCreate() {
    ...
    const [locationStatus, setLocationStatus] = useState('Koordinat akan diambil otomatis dari lokasi saat ini.');
    ...
    const loadCurrentLocation = () => {
        ...
        navigator.geolocation.getCurrentPosition(
            ...
            () => {
                setData('koordinat_lokasi', '');
                setLocationStatus('Koordinat tidak tersedia. Form tetap bisa disimpan tanpa koordinat.');
            },
    ...
    const handleSubmit = (event: React.FormEvent) => {
        ...
        post(route('kegiatan-penyuluhan.store'));
    };

    return (
        <>
            <Head title="Tambah Kegiatan Penyuluhan" />
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    placeholder="Masukkan jumlah sasaran"
                                    className="mt-1"
                                />
