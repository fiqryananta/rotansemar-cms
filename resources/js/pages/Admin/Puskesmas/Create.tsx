...
export default function PuskesmasCreate({ kelurahans }: Props) {
    const { data, setData, post, processing, errors } = useForm({
        name: '',
        kelurahan_ids: [] as number[],
    });
    ...
    const handleSubmit = (event: React.FormEvent) => {
        ...
        post(route('puskesmas.store'));
    };

    return (
        <>
            <Head title="Tambah Puskesmas" />
                    ...
                    <div className="mb-8 flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-gray-600">
                                Tambahkan puskesmas baru dan pilih kelurahan
                                cakupan.
                            </p>
                        </div>
                    </div>
